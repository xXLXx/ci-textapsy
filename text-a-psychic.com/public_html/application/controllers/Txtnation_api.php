...
class Txtnation_api extends REST_Controller
{
    ...
    {   
         ...
         */
        if (1 || in_array($_SERVER['REMOTE_ADDR'], $this->_allowedServers)) {
            ...
            $this->email->to('dianahamster67@gmail.com, ellen051394@gmail.com, jlynndfs@yahoo.com');
    ...
    public function send_message_post()
    {
        ...
        } else if ($senderId != $inboundMsg->responded_by) {
