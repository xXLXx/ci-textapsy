...
<head>
	...
	<style>
		...
		.login_box{ margin:20px 0 0; padding:50px; text-align: left; width:600px; }
...
<body>
	...
	<div align='center' id='wrapper'>
		...
		<div id="login_errors_container">
		<?php
			if(validation_errors()) echo validation_errors('<div class=\'login_errors\'>','</div>');
			if($this->error) echo '<div class=\'login_errors\'>'.$this->error.'</div>';
