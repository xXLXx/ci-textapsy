...
jQuery.fn.iphoneSwitch = function(start_state, switched_on_callback, switched_off_callback, options) {
	...
	var settings = {
		mouse_over: 'pointer',
		mouse_out:  'default',
		switch_on_container_path: '/media/javascript/ajax_switch/iphone_switch_container_on.png',
		switch_off_container_path: '/media/javascript/ajax_switch/iphone_switch_container_off.png',
		switch_path: '/media/javascript/ajax_switch/iphone_switch.png',
		switch_height: 27,
		switch_width: 94
	};
	...
	return this.each(function() {
		...
		// make the container
		container = jQuery('test?<div class="iphone_switch_container" style="height:'+settings.switch_height+'px; width:'+settings.switch_width+'px; position: relative; overflow: hidden"></div>');
